...
# MAKE SURE HF DOWNLOADS TO THE APPROPRIATE DIRECTORY
###########################################################
sm_data_path = Path("/opt/ml/input/data/")
download_path = sm_data_path / "download"
cache_path = sm_data_path / "cache"
download_path.mkdir(exist_ok=True, parents=True)
cache_path.mkdir(exist_ok=True, parents=True)
datasets.config.DOWNLOADED_DATASETS_PATH = download_path 
...
class DataTrainingArguments:
    ...
    load_data_from_disk: Optional[bool] = field(
        default=False, metadata={"help": "Loads dataset from disk. dataset_name must be a path to the data"}
    )
...
def main():
    ...
    # download the dataset.
        ...
        if data_args.load_data_from_disk:
